    ...
    return (
        <div
            ...
            <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
                <h2 className="flex text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white sm:text-5xl md:text-6xl justify-center text-center">
            ...
            <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
                {data.map((item, index) => (
                    <div
                        ...
                        <div className="relative pl-20 pr-4 md:pl-4 w-full text-gray-800 dark:text-gray-200">
